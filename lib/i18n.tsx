...
const translations: Record<Locale, Translations> = {
  ar: {
    ...
    "dash.subtitle": "نظرة عامة على مهاراتك في الأمن السيبراني",
    "dash.overallScore": "النتيجة الإجمالية",
    "dash.trainingSessions": "جلسات التدريب",
    "dash.threatsDetected": "تهديدات مكتشفة",
    "dash.legalKnowledge": "المعرفة القانونية",
    "dash.quickActions": "إجراءات سريعة",
    "dash.recentActivity": "النشاط الأخير",
    "dash.startSim": "ابدأ محاكاة جديدة",
    "dash.analyzeMsg": "حلل رسالة",
    "dash.takeLegalQuiz": "اختبار قانوني",
    "dash.readTips": "اقرأ النصائح",
    "dash.noActivity": "لم تبدأ التدريب بعد — ابدأ الآن!",
    "dash.level": "المستوى",
    "dash.beginner": "مبتدئ",
    "dash.intermediate": "متوسط",
    "dash.advanced": "متقدم",
    "dash.expert": "خبير",
    "dash.modules": "الوحدات التدريبية",
    "dash.phishingModule": "كشف التصيد الاحتيالي",
    "dash.analyzerModule": "تحليل الرسائل المشبوهة",
    "dash.legalModule": "القوانين السيبرانية التونسية",
    "dash.tipsModule": "نصائح الحماية الرقمية",
  ...
  en: {
    ...
    "dash.subtitle": "Overview of your cybersecurity skills",
    "dash.overallScore": "Overall Score",
    "dash.trainingSessions": "Training Sessions",
    "dash.threatsDetected": "Threats Detected",
    "dash.legalKnowledge": "Legal Knowledge",
    "dash.quickActions": "Quick Actions",
    "dash.recentActivity": "Recent Activity",
    "dash.startSim": "Start New Simulation",
    "dash.analyzeMsg": "Analyze a Message",
    "dash.takeLegalQuiz": "Legal Quiz",
    "dash.readTips": "Read Tips",
    "dash.noActivity": "You haven't started training yet — start now!",
    "dash.level": "Level",
    "dash.beginner": "Beginner",
    "dash.intermediate": "Intermediate",
    "dash.advanced": "Advanced",
    "dash.expert": "Expert",
    "dash.modules": "Training Modules",
    "dash.phishingModule": "Phishing Detection",
    "dash.analyzerModule": "Suspicious Message Analysis",
    "dash.legalModule": "Tunisian Cyber Laws",
    "dash.tipsModule": "Digital Protection Tips",
  ...
  fr: {
    ...
    "dash.subtitle": "Apercu de vos competences en cybersecurite",
    "dash.overallScore": "Score global",
    "dash.trainingSessions": "Sessions d'entrainement",
    "dash.threatsDetected": "Menaces detectees",
    "dash.legalKnowledge": "Connaissances juridiques",
    "dash.quickActions": "Actions rapides",
    "dash.recentActivity": "Activite recente",
    "dash.startSim": "Demarrer une simulation",
    "dash.analyzeMsg": "Analyser un message",
    "dash.takeLegalQuiz": "Quiz juridique",
    "dash.readTips": "Lire les conseils",
    "dash.noActivity": "Vous n'avez pas encore commence — commencez maintenant !",
    "dash.level": "Niveau",
    "dash.beginner": "Debutant",
    "dash.intermediate": "Intermediaire",
    "dash.advanced": "Avance",
    "dash.expert": "Expert",
    "dash.modules": "Modules de formation",
    "dash.phishingModule": "Detection de phishing",
    "dash.analyzerModule": "Analyse de messages suspects",
    "dash.legalModule": "Lois cyber tunisiennes",
    "dash.tipsModule": "Conseils de protection numerique",
    "dash.progress": "Progres",
